...
fn report(mode: &str, input: usize, archive: usize, roundtrip: u32, dirs: usize, dmode: DirMode) {
    ...
    println!(
        "PILOT|mode={}|dirs={}|dir_mode={}|input_bytes={}|archive_bytes={}|decoder_src_bytes={}|total_bytes={}|ratio_x={}.{:04}|bpc={}.{:04}|archive_ratio=NOT_CLAIMED|claims_final_apex=0|roundtrip={}",
        mode, dirs, dirmode_name(dmode), input, archive, dsrc, total, ratio_e4 / 10_000, ratio_e4 % 10_000, bpc_e4 / 10_000, bpc_e4 % 10_000, roundtrip
    );
}
